...
export async function initBudgetPanel() {
  ...
  function render() {
    const fields = ['mortgageInterest', 'mortgagePrincipal', 'escrow', 'electric', 'water', 'gas', 'internet', 'cell', 'food', 'transport', 'tolls', 'insurance', 'healthcare', 'savings', 'prime', 'spotify', 'misc'];
    const categories = {};

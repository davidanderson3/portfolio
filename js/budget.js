...
export async function initBudgetPanel() {
  ...
  function render() {
    const fields = ['mortgageInterest', 'mortgagePrincipal', 'homeInsurance', 'electric', 'water', 'gas', 'internet', 'cell', 'food', 'transGas', 'carPayment', 'tolls', 'insurance', 'healthInsurance', 'healthcare', 'savings', 'tsp', 'hsa', 'prime', 'spotify', 'misc'];
    const categories = {};
